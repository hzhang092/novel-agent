...
def test_layout_round_trip_preserves_settings(tmp_path):
    ...
    store.layout.world.visible_sections = ["geography", "power_system"]
    store.layout.world.collapsed_sections = ["geography"]
...
def test_unknown_layout_ids_do_not_prevent_loading(tmp_path):
    ...
    assert store.layout.world.visible_sections == ["future-section"]
